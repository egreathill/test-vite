...
const Aboutus = () => {
    document.title = 'About Us | Plurk – Tailwind CSS Multipurpose Landing Templates';
        ...
        <div>
            ...
            <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
                ...
                <div className="bottom-0 ltr:right-0 rtl:left-0 lg:absolute" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                    <img src="/assets/images/about-who-bg.png" alt="about-who-bg" className="rtl:rotate-y-180" />
                </div>
            </section>
                    ...
                    <div className="grid gap-4 pt-5 sm:grid-cols-3 md:gap-[30px] lg:grid-cols-4 lg:pt-0">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-1.png" alt="award-1" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-2.png" alt="award-2" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-3.png" alt="award-3" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-4.png" alt="award-4" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-5.png" alt="award-5" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-6.png" alt="award-6" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-7.png" alt="award-7" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                                <img src="/assets/images/award-8.png" alt="award-8" className="mx-auto h-[100px]" />
                            </div>
                        </div>
                    </div>
                </div>
